...
// transferRequest defines the request payload for transfer handler
...
// validateAccountCurrency checks if the given account ID has the same currency as the currency in the request
